        ...
        <div class="row">
            ...
            <div class="main col-sm-8">
                ...
                <div id="blog-listing" class="list-style clearfix">
                    <div class="row">
                         <%-- loops content from cms on the article on the ui hence use the children tag --%>
                        <% loop $Children %>
                            ...
                            <div class="info-blog">
                                <ul class="top-info">
                                    ...
                                    <li><i class="fa fa-tags"></i><% loop $Categories %>$Title<% if not $Last %>, <% end_if %><% end_loop %></li>
                                </ul>
